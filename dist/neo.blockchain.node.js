module.exports = function (network) {
  ...
  */
  function node (conf) {
    ...
    */
    this.getBalance = (asset_id) => new Promise((resolve, reject) => {
      this.call({
        method: 'getbalance',
        params: [],
        id: 0
    ...
    */
    ...
    this.sendToAddress = (asset_id, address, value) => new Promise((resolve, reject) => {
      this.call({
    ...
    * @example
    * this.call({'method': 'getblock', 'params': [666,1], 'id': 0})
    */
